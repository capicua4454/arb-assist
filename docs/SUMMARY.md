...
* [Welcome to arb-assist](README.md)

## Introduction

* [Overview](introduction/overview.md)
* [Key Features](introduction/features.md)
* [Supported Bots](introduction/supported-bots.md)
...
* [Connection Settings](configuration/connection-settings.md)
* [DEX & Program Configuration](configuration/dex-configuration.md)
* [Mint Selection & Ranking](configuration/mint-selection.md)
* [Trading Strategies](configuration/trading-strategies.md)
* [Advanced Settings](configuration/advanced-settings.md)

## Bot Integration

* [SMB-Onchain Setup](bot-integration/smb-onchain.md)
* [NotArb Setup](bot-integration/notarb.md)

## Advanced Features

* [File Server Mode](advanced-features/file-server.md)
* [Dynamic Fee Adjustment](advanced-features/dynamic-fees.md)
...
* [License Issues](troubleshooting/license.md)
